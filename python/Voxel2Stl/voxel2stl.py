...
def vtk_to_stl_with_padding(input_vtk_file, output_stl_file, iso_value):
    # 检查文件是否存在
    ...
    print(f"等值面 {iso_value} 已保存到 {output_stl_file} 中。")

# 示例使用
input_vtk = "Loop100.vtk"  # 替换为你的 VTK 文件路径
output_stl = "output_with_padding.stl"  # 替换为输出 STL 文件路径
iso_value = 0.9                     # 替换为你的等值面值

vtk_to_stl_with_padding(input_vtk, output_stl, iso_value)
